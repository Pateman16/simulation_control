...
import time
import sys
sys.path.insert(0, '/home/pateman/catkin_ws/src/simulation_control/src/scripts/')

## LOAD CONFIG PARAMS ##
if (os.path.isfile('/home/pateman/catkin_ws/src/simulation_control/src/scripts/config.yml')):
    with open("/home/pateman/catkin_ws/src/simulation_control/src/scripts/config.yml", 'r') as ymlfile:
